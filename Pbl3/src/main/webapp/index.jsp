					...
					<ul
						...
						<c:if test="${sessionScope.acc != null }">
							<li class="nav__listitem nav-item px-3 px-xl-4"><a
								class="nav-link fw-medium" aria-current="page" onclick="return false;" href="#" >Hello
	...
	<main class="main" id="top">
								...
								<div class="modal-dialog modal-dialog-centered modal-lg">
									<div class="modal-content">
										<iframe class="rounded"
											...
											src="https://www.youtube.com/embed/6EbEAGB6odM"
		...
		<div class="swiper mySwiper">
			<div class="swiper-wrapper">
				<div class="swiper-slide"><img src="assets/img/dest/banner1.jpg"></div>
				<div class="swiper-slide"><img src="assets/img/dest/banner2.jpg"></div>
				<div class="swiper-slide"><img src="assets/img/dest/banner3.jpg"></div>
				<div class="swiper-slide"><img src="assets/img/dest/banner4.jpg"></div>
			</div>
				...
				<div class="row">
					<div class="col-md-4 mb-4">
						<div class="card overflow-hidden shadow">
							<img class="card-img-top" src="assets/img/tour/bantayvang.jpg"
								alt="Rome, Italty" />
					...
					<div class="col-md-4 mb-4">
						<div class="card overflow-hidden shadow">
							<img class="card-img-top" src="assets/img/tour/hoian.jpg"
								alt="London, UK" />
							<div class="card-body py-4 px-3">
								<div
									class="d-flex flex-column flex-lg-row justify-content-between mb-3">
					...
					<div class="col-md-4 mb-4">
						<div class="card overflow-hidden shadow">
							<img class="card-img-top" src="assets/img/tour/rungdua7mau.jpg"
								alt="Full Europe" />
							<div class="card-body py-4 px-3">
								<div
									class="d-flex flex-column flex-lg-row justify-content-between mb-3">
