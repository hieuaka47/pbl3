...
<!--    Stylesheets-->
<!-- ===============================================-->
<link href="css/header_home.css" rel="stylesheet" />
						...
						<c:if test="${sessionScope.acc != null }">
							<li class="nav__listitem nav-item px-3 px-xl-4"><a
								...
								<ul class="nav__listitemdrop">
									<li><a ${sessionScope.acc.role == 1 ? 'href="/Pbl3/transfer?location=update_user"' : 'href="update_user"'}>Your Profile</a></li>
									<c:if test="${sessionScope.acc.role != 1 }">
										<li><a href="">Order</a></li>
									</c:if>
									<li><a ${sessionScope.acc.role == 1 ? 'href="/Pbl3/transfer?location=logout"' : 'href="logout"'}>Log out</a></li>
								</ul></li>
						</c:if>
						<c:if test="${sessionScope.acc == null }">
							<li class="nav-item px-3 px-xl-4"><a
